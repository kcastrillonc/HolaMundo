...
k2_fin = 3.0  # Constante k al final de Compresión Adiabática

T1 = 1.0                              # Temperatura del baño térmico frío
...
eta = np.sort(eta)[400:-400]
dos_eta = np.sort(dos_eta)[400:-400]
tres_eta = np.sort(tres_eta)[400:-400]
cuatro_eta = np.sort(cuatro_eta)[400:-400]
